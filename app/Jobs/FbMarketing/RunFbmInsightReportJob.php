...
class RunFbmInsightReportJob implements ShouldQueue
{
    ...
    {
        $coordinator->executeAsync($this->reportUuid);
    }

    public function failed(Throwable $exception): void
    {
        try {
            app(FbmInsightReportCoordinatorService::class)->markFailed($this->reportUuid, 'Historical Insights backfill exhausted its bounded queue attempts and stopped safely.');
