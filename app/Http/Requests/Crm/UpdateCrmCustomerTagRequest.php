...
class UpdateCrmCustomerTagRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'name' => ['bail', 'required', 'string', 'max:120', Rule::unique('crm_customer_tags', 'name')->ignore($tagId)],
            'slug' => ['nullable', 'string', 'max:160', 'alpha_dash', Rule::unique('crm_customer_tags', 'slug')->ignore($tagId)],
