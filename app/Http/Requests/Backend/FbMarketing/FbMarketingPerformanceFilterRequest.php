...
class FbMarketingPerformanceFilterRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'status' => ['nullable', 'string', 'max:80', 'regex:/^[A-Z0-9_ -]+$/'],
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator) {
            ...
            if ($toDate->gte($fromDate) && $fromDate->diffInDays($toDate) > 365) {
                $validator->errors()->add('to_date', 'The performance range may not exceed 366 calendar days.');
            }
        });
    }
}
