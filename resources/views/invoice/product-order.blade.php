    ...
    <div class="invoice-container">
        ...
        <div class="invoice-header">
            ...
            <div class="qr-code-header">
                ...
                @endphp
                <img src="https://api.qrserver.com/v1/create-qr-code/?size=90x90&data={{ urlencode($qrUrl) }}"
                    alt="QR Code">
            </div>
        </div>
        ...
        <div class="info-row">
            <div class="info-section">
                <h6>{{ $orderType == 'quotation' ? 'QUOTATION DETAILS' : 'INVOICE DETAILS' }}</h6>
                <p>
                    <strong>
                        {{ $orderType == 'quotation' ? 'Quotation No:' : 'Invoice No:' }}
                    </strong> 
                    {{ $order->order_code }}
                </p>
                ...
                <p><strong>Status:</strong> <span
                        class="status-badge status-{{ strtolower($order->order_status) }}">{{ ucfirst($order->order_status) }}</span>
                </p>
                @if ($order->reference)
