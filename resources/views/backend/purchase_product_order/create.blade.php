                    ...
                    <form action="{{ url('save/new/purchase-product/order') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4 mb-4">
                                ...
                                <select id="order_status" required class="form-control" name="order_status">
                            ...
                            <div class="col-md-4 mb-4">
                                ...
                                <select id="purchase_product_warehouse_id" required data-toggle="select2" class="form-control"
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="mb-3 w-50">
                                <div style="position: relative;">
                                    ...
                                    <div v-if="searchResults && searchResults.length > 0" class="dropdown-menu searchResultsClass">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody id="purchaseItems">
                                <tr v-for="(item, index) in purchaseItems" :key="item.rowKey" v-if="item.isVisible">
                                    ...
                                    <td>
                                        <select class="form-control" :name="`product[${index}][warehouse_room_id]`" v-model="item.warehouse_room_id" @change="onRowRoomChange(item)" :disabled="!selectedWarehouse">
                                            <option value="">Select Room</option>
                                            <option v-for="room in rooms" :value="room.id" :key="`room-${room.id}`">
                                                @{{ room.title }}
                                            </option>
                                        </select>
                                    </td>
                                    <td>
                                        <select class="form-control" :name="`product[${index}][warehouse_cartoon_id]`" v-model="item.warehouse_cartoon_id" :disabled="!item.warehouse_room_id">
                                            <option value="">Select Cartoon</option>
                                            <option v-for="cartoon in item.cartoonOptions" :value="cartoon.id" :key="`cartoon-${cartoon.id}`">
                                                @{{ cartoon.title }}
                                            </option>
                                        </select>
                                    </td>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-6">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row form-group">
                                            <label for="" class="col-sm-6 control-label">Total Products</label>
                                            <div class="col-sm-4">
                                                <label class="control-label total_products text-success"
                                        ...
                                        <div class="row form-group">
                                            <label for="" class="col-sm-6 control-label">Total Quantities</label>
                                            <div class="col-sm-4">
                                ...
                                <div class="row d-none">
                                    <div class="col-md-12">
                                        <div class="row form-group">
                                            <label for="discount_to_all_input" class="col-sm-4 control-label">
                                                Discount on All
                                            </label>
                                            <div class="col-sm-4">
                                                <input type="text" 
                                                    ...
                                                    @input="handleDiscountOnAllInput"/>
                                            </div>
                                            <div class="col-sm-4">
                                                <select class="form-control" 
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text"
                                                    class="form-control text-right only_currency"
                                                    id="round_off_input"
                                                    name="total_round_off_amt"
                                                    v-model="round_off_input"
                                                    @input="handleRoundOffInput"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <button type="submit" id="submitPurchaseBtn" class="btn btn-success mt-3">
                            <span id="submitBtnText">Submit Purchase</span>
...
@section('footer_js')
    ...
    <script type="text/javascript">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const form = document.querySelector('form[action*="save/new/purchase-product/order"]');
            ...
            if (form && submitBtn) {
                ...
                // Re-enable button if form validation fails (form won't submit)
                form.addEventListener('invalid', function(e) {
                    isSubmitting = false;
                    submitBtn.disabled = false;
                    submitBtnText.textContent = 'Submit Purchase';
