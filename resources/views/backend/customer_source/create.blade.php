        ...
        <div class="col-lg-12 col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="needs-validation" method="POST" action="{{url('save/new/customer-source')}}" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="title" name="title" maxlength="255" class="form-control" placeholder="Enter Customer Source Type Title Here" >
                                            <div class="invalid-feedback" style="display: block;">
                                                @error('title')
