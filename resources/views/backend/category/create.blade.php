                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea name="short_description" id="short_description" class="form-control" rows="3"
                                    placeholder="Best Fashion Brands in Bangladesh"></textarea>
    ...
    <script>
        $(document).ready(function() {
            $('form').on('submit', function() {
                $('button[type="submit"]').html('<i class="fas fa-spinner fa-spin"></i> Saving...').prop(
                    'disabled', true);
            });
        });
    </script>
