            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="needs-validation" method="POST"
                        action="{{ url('update/customer-next-contact-date') }}" enctype="multipart/form-data">
                        @csrf
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="next_date" name="next_date"
                                                class="form-control" value="{{ $data->next_date }}" placeholder="Enter next date Here">
                                            <div class="invalid-feedback" style="display: block;">
                                                @error('next_date')
                                                    <strong>{{ $message }}</strong>
                                                @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="contact_status" id="contact_status" class="form-control custom-select">
                                                <option value="pending" {{ $data->contact_status == 'pending' ? 'selected' : '' }}>Pending</option>
                                                <option value="missed" {{ $data->contact_status == 'missed' ? 'selected' : '' }}>Missed</option>
                                                <option value="done" {{ $data->contact_status == 'done' ? 'selected' : '' }}>Done</option>
                                            </select>
                                        </div>
