                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="payment_category" name="payment_category" class="form-control">
                                                ...
                                                <option value="mobile" {{ $data->payment_category == 'mobile' ? 'selected' : '' }}>Mobile</option>
                                                <option value="bank" {{ $data->payment_category == 'bank' ? 'selected' : '' }}>Bank</option>
                                                <option value="gateway" {{ $data->payment_category == 'gateway' ? 'selected' : '' }}>Gateway</option>
                                            </select>
                                            <div class="invalid-feedback" style="display: block;">
