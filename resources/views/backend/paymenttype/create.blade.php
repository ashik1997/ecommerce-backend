                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="payment_category" name="payment_category" class="form-control">
                                                ...
                                                <option value="mobile" {{ old('payment_category') == 'mobile' ? 'selected' : '' }}>Mobile</option>
                                                <option value="bank" {{ old('payment_category') == 'bank' ? 'selected' : '' }}>Bank</option>
                                                <option value="gateway" {{ old('payment_category') == 'gateway' ? 'selected' : '' }}>Gateway</option>
                                            </select>
                                            <div class="invalid-feedback" style="display: block;">
