    ...
    <div class="container-fluid">
        ...
        <div id="packageCreateApp" v-cloak>
            ...
            <div class="package_management">
                <div class="pm-draft-banner" v-if="autoSave.hasStoredData">
                    <div>
                        <i class="fas fa-history" style="margin-right:6px;"></i>
                        <strong>Draft detected.</strong>
                        <span style="display:block; margin-top:2px;">You have unsaved package data from @{{ autoSave.lastSavedTime | formatDateTime }}.</span>
                    </div>
                    <div class="pm-draft-banner__actions">
                        <button class="pm-btn pm-btn--primary pm-btn--sm" @click="restoreDraft">
                            <i class="fas fa-undo"></i> Restore
                        </button>
                        <button class="pm-btn pm-btn--danger-ghost pm-btn--sm" @click="discardDraft">
            ...
            <div class="package_management">
                <div class="pm-action-bar">
                    ...
                    <div class="pm-action-right">
                        ...
                        <button type="button" class="pm-btn pm-btn--primary pm-btn--lg"
                            @click="submitPackage" :disabled="isSubmitting">
                            <span v-if="!isSubmitting"><i class="fas fa-save"></i> Create Package</span>
                            <span v-else><span class="spinner-border spinner-border-sm" style="width:14px;height:14px;border-width:2px;"></span> Processing…</span>
                        </button>
                    </div>
                </div>
            </div>
