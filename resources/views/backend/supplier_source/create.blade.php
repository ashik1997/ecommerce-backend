        ...
        <div class="col-lg-12 col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="needs-validation" method="POST" action="{{url('save/new/supplier-source')}}" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="title" name="title" maxlength="255" class="form-control" placeholder="Enter Supplier Source Type Title Here" >
                                            <div class="invalid-feedback" style="display: block;">
                                                @error('title')
                        ...
                        <div class="form-group text-center pt-3">
                            <a href="{{url('view/all/supplier-source')}}" style="width: 130px;" class="btn btn-danger d-inline-block text-white m-2" type="submit"><i class="mdi mdi-cancel"></i> Cancel</a>
