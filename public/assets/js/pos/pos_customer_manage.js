            ...
            <tbody>
                <tr v-for="customer in customers.data" :key="customer.id">
                    ...
                    <td>
                        ...
                        <small v-if="customer.customer_type === 'company'" class="text-muted">{{ customer.company_name || customer.trade_name }}</small>
                    </td>
    ...
    <div class="customer_view_wrapper">
        <div class="border p-4 rounded">
            ...
            <div v-if="viewCustomer" class="customer-profile">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                <strong>Type:</strong> {{ viewCustomer.customer_type || 'person' }}
                            </div>
                            <div class="col-md-6 mb-3" v-if="viewCustomer.customer_type === 'company'">
                                <strong>Company:</strong> {{ viewCustomer.company_name || 'N/A' }}
                            </div>
                            <div class="col-md-6 mb-3" v-if="viewCustomer.customer_type === 'company'">
                                <strong>Trade Name:</strong> {{ viewCustomer.trade_name || 'N/A' }}
                            </div>
                            <div class="col-md-6 mb-3">
                ...
                <div class="card mb-3" v-if="viewCustomer.customer_type === 'company'">
                    <div class="card-header bg-secondary text-white">
                        <h5 class="mb-0"><i class="fas fa-address-card"></i> Contact Persons</h5>
                    </div>
                    <div class="card-body">
                        <div v-if="viewCustomer.contact_persons && viewCustomer.contact_persons.length">
                            <div v-for="contact in viewCustomer.contact_persons" :key="'contact-view-' + contact.id" class="border p-3 mb-2">
                                <strong>{{ contact.name || 'N/A' }}</strong>
                                <span v-if="contact.is_primary" class="badge badge-success ml-1">Primary</span>
                                <div class="text-muted">{{ contact.designation || '' }} {{ contact.department ? '- ' + contact.department : '' }}</div>
                                <div>{{ contact.phone || 'N/A' }} <span v-if="contact.email"> | {{ contact.email }}</span></div>
                            </div>
                        </div>
                        <div v-else class="text-muted text-center py-3">No contact persons found</div>
                    </div>
                </div>
    ...
    <div class="customer_form_wrapper">
        <form @submit.prevent="save_customer" id="customer_form" style="max-width: 768px;" class="border p-3 rounded">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="customer_type" v-model="form_customer.customer_type">
                    <option value="person">Person</option>
                    <option value="company">Company</option>
                </select>
            </div>
            <div v-if="form_customer.customer_type === 'company'" class="border p-3 mb-3">
                <div class="form-group">
                    <label>Company Name</label>
                    <input type="text" class="form-control" v-model="form_customer.company_name">
                </div>
                <div class="form-group">
                    <label>Trade Name</label>
                    <input type="text" class="form-control" v-model="form_customer.trade_name">
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label>BIN</label>
                        <input type="text" class="form-control" v-model="form_customer.bin_no">
                    </div>
                    <div class="form-group col-md-6">
                        <label>TIN</label>
                        <input type="text" class="form-control" v-model="form_customer.tin_no">
                    </div>
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group"">
                ...
                <select class="form-control" id="customer_source" v-model="form_customer.customer_source_type_id">
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    ...
                    <input type="number" min="0" step="0.01" class="form-control" v-model="form_customer.credit_limit">
                </div>
                <div class="form-group col-md-4">
                    <label>Payment Terms (days)</label>
                    <input type="number" min="0" class="form-control" v-model="form_customer.payment_terms_days">
                </div>
                <div class="form-group col-md-4 d-flex align-items-end">
                    <label class="mb-2">
                        <input type="checkbox" v-model="form_customer.allow_due">
                        Allow Due
                    </label>
                </div>
            </div>
            ...
            <div v-if="form_customer.customer_type === 'company'" class="border p-3 mb-3">
                ...
                <div v-for="(contact, index) in contact_persons" :key="'contact-' + index" class="border p-2 mb-2">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label>Name</label>
                    ...
                    <label>
                        <input type="checkbox" v-model="contact.is_primary" @change="set_primary_contact(index)">
                        Primary Contact
                    </label>
                    <button type="button" class="btn btn-sm btn-danger float-right" @click="remove_contact_person(index)">
                        <i class="fas fa-trash"></i> Remove
                    </button>
                </div>
                <button type="button" class="btn btn-sm btn-primary" @click="add_contact_person">
            ...
            <div class="border p-3 mb-3">
                ...
                <div v-for="(billing_address, index) in billing_address" :key="'billing-' + index" class="border p-2 mb-2">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" v-model="billing_address.district">
            ...
            <div class="border p-3 mb-3">
                ...
                <div v-for="(shipping_address, index) in shipping_address" :key="'shipping-' + index" class="border p-2 mb-2">
                    ...
                    <div class="form-group">
                        <label>District</label>
                        <select class="form-control" v-model="shipping_address.district">
                            <option :value="null">Select District</option>
                            <option v-for="district in districts" :key="district.district_id" :value="district">
                                {{ district.division_name }} > {{ district.district_name }}
                            </option>
...
Vue.component('pos-customer-manage', {
    ...
    data: function () {
        return {
            ...
            contact_persons: [{ name: '', designation: '', phone: '', email: '', department: '', is_primary: true, note: '' }],
            save_as_user: false,
            password: '',
            districts: [],
    ...
    methods: {
        ...
        save_customer: function () {
            ...
            const payload = {
                ...
                customer_type: this.form_customer.customer_type || 'person',
                company_name: this.form_customer.company_name || null,
                trade_name: this.form_customer.trade_name || null,
                bin_no: this.form_customer.bin_no || null,
                tin_no: this.form_customer.tin_no || null,
                credit_limit: this.form_customer.credit_limit || 0,
                payment_terms_days: this.form_customer.payment_terms_days || null,
                allow_due: this.form_customer.allow_due ? 1 : 0,
            };
            ...
            if (payload.customer_type === 'company') {
                payload.contact_persons = this.contact_persons
        ...
        add_contact_person: function () {
            this.contact_persons.push({ name: '', designation: '', phone: '', email: '', department: '', is_primary: this.contact_persons.length === 0, note: '' });
        },
        remove_contact_person: function (index) {
            this.contact_persons.splice(index, 1);
            if (this.contact_persons.length === 0) {
                this.add_contact_person();
            }
            if (!this.contact_persons.some(contact => contact.is_primary)) {
                this.contact_persons[0].is_primary = true;
            }
        },
        set_primary_contact: function (index) {
            if (!this.contact_persons[index].is_primary) {
                if (!this.contact_persons.some(contact => contact.is_primary)) {
                    this.contact_persons[index].is_primary = true;
                }
                return;
            }
            this.contact_persons.forEach((contact, i) => {
        ...
        change_type: function (type = 'list', customerData = null) {
            ...
            if (type === 'add') {
                ...
                this.contact_persons = [{ name: '', designation: '', phone: '', email: '', department: '', is_primary: true, note: '' }];
                ...
                this.customer = {
                    ...
                    customer_type: customerData.customer_type || 'person',
                    company_name: customerData.company_name || '',
                    trade_name: customerData.trade_name || '',
                    bin_no: customerData.bin_no || '',
                    tin_no: customerData.tin_no || '',
                    credit_limit: customerData.credit_limit || 0,
                    payment_terms_days: customerData.payment_terms_days || null,
                    allow_due: customerData.allow_due !== false,
                };
                this.form_customer = Object.assign({}, customerData, this.customer);
                this.contact_persons = customerData.contact_persons && customerData.contact_persons.length
                    ? customerData.contact_persons.map(contact => Object.assign({}, contact))
                    : [{ name: '', designation: '', phone: '', email: '', department: '', is_primary: true, note: '' }];
        ...
        <div>
            <div class="pos_customer_info">
                ...
                <div v-if="customer && customer.id > 1" class="customer_analytics">
                    <div v-if="customer.customer_type === 'company' && customer.contact_persons && customer.contact_persons.length" style="min-width: 180px;">
                        <select class="form-control form-control-sm" v-model="customer.selected_contact_person_id">
                            <option :value="null">Select Contact</option>
                            <option v-for="contact in customer.contact_persons" :key="'selected-contact-' + contact.id" :value="contact.id">
                    ...
                    <div v-if="customer?.due_amount > 0">
                        ...
                        <button type="button" class="btn btn-sm btn-danger ml-2" @click.stop="openCustomerDuePayment(customer)">
